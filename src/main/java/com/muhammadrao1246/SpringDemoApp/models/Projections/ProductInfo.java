 ...
 */
public record ProductInfo(UUID id, String name, String description, BigDecimal price, BigDecimal quantity, Instant createdAt, BrandInfo brand, CategoryInfo category) implements Serializable{
}
